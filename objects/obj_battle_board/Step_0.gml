...
surface_set_target(__surface_frame);
	shader_set(shd_mask_clip);
		...
		texture_set_stage(0, surface_get_texture(surface_mask));          // tex_mask is your surface or texture
		shader_set_uniform_i(shd_mask_clip_mask, 0);         // Use texture stage 0
		shader_set_uniform_f(shd_mask_clip_bgcolor, 0,0,0,1);
		draw_rectangle(0, 0, 640, 480, true);
	shader_reset();
surface_reset_target();
